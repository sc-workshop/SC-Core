...
set_global(SC_GNU_DEF_fe "$<STREQUAL:${CMAKE_CXX_COMPILER_FRONTEND_VARIANT},GNU>")
set_global(SC_GNU_APPLE_fe "$<STREQUAL:${CMAKE_CXX_COMPILER_FRONTEND_VARIANT},AppleClang>")
set_global(SC_GNU_fe "$<OR:${SC_GNU_DEF_fe},${SC_GNU_APPLE_fe}>")
set_global(SC_MSVC_fe "$<STREQUAL:${CMAKE_CXX_COMPILER_FRONTEND_VARIANT},MSVC>")

set_global(SC_CLANG "$<OR:${SC_GNU_fe},$<CXX_COMPILER_ID:Clang>>")
set_global(SC_GNU "$<OR:${SC_GNU_fe},$<CXX_COMPILER_ID:GNU>>")
set_global(SC_MSVC "$<OR:${SC_MSVC_fe},$<CXX_COMPILER_ID:MSVC>>")

set_global(SC_DEBUG "$<CONFIG:Debug>")
set_global(SC_RELEASE "$<CONFIG:Release,RelWithDebInfo,MinSizeRel>")
